        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_alarm) {
                    Intent a = new Intent(TambahData.this,
                            MainActivity.class);
                    startActivity(a);
                    ...
                    Intent a = new Intent(TambahData.this, MainActivity.class);
                    startActivity(a);
                }
                return true;
            }
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long rec = sqLiteDatabase.insert("daftarlapangan", null, cv);
                if (rec != null) {
                    Toast.makeText(TambahData.this, "Success to Insert Data", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(TambahData.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
//for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TambahData.this, DisplayDataLapangan.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(TambahData.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
                    ...
                    Intent a = new Intent(TambahData.this, DisplayDataLapangan.class);
                    startActivity(a);
                }
            }
        });
